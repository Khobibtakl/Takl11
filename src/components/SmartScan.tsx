...
import { extractTextFromImageStream, chatWithImageStream, ChatMessage } from '../services/geminiService';
          ...
          <div className="w-full md:w-2/3 flex flex-col bg-[var(--bg-surface)] border border-[var(--line-color)]/60 rounded-2xl md:rounded-3xl shadow-sm overflow-hidden flex-1 shrink min-h-[400px] relative">
             ...
             <div className="p-3 bg-[var(--bg-surface)] border-t border-[var(--line-color)]/60 shrink-0">
               ...
               >
                 <input
                   type="text"
                   className="flex-1 bg-transparent border-none outline-none px-3 text-[var(--text-main)] placeholder-gray-400 text-sm"
                 ...
                 <button 
                   ...
                   className="p-2.5 bg-primary text-white rounded-xl hover:bg-primary-hover transition-colors disabled:opacity-50 shadow-sm shrink-0"
                 >
